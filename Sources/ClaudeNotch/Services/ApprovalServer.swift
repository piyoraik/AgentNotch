...
final class ApprovalServer {
    ...
    private let acceptQueue = DispatchQueue(label: "ClaudeNotch.approval.accept")
    private let connectionQueue = DispatchQueue(label: "ClaudeNotch.approval.connection", attributes: .concurrent)
